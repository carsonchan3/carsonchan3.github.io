...
export function getPremiumProductContent(familyId: string, language: WebsiteLanguage): PremiumProductContent | undefined {
  ...
  return {
    ...
    equipmentTierPartsLabel: detail.equipmentTierPartsLabel,
    equipmentTierPartsDescription: detail.equipmentTierPartsDescription,
    equipmentTierVerifiedLabel: detail.equipmentTierVerifiedLabel,
    equipmentTierVerifiedDescription: detail.equipmentTierVerifiedDescription,
    careAddOnTitle: detail.careAddOnTitle,
    careAddOnDescription: detail.careAddOnDescription,
